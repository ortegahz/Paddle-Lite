...
if(ARMLINUX)
    ...
    if(ARMLINUX_ARCH_ABI STREQUAL "armv8")
        set(CMAKE_CXX_FLAGS "-march=armv8-a -mfloat-abi=softfp -mfpu=neon ${CMAKE_CXX_FLAGS}")
        set(CMAKE_C_FLAGS "-march=armv8-a -mfloat-abi=softfp -mfpu=neon ${CMAKE_C_FLAGS}")
